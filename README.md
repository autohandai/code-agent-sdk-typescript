...
Use the Bun version declared in `package.json` (currently 1.4.2) and Node.js 24.
Every CI and release job reads that declaration. CI installs the committed `bun.lock` with
